...
const getters = {
    ...
    isSparkAllowed: (state, getters): boolean => getters.apiStatusData.isSpark,
    lelantusGracefulPeriod: (state, getters): number => getters.apiStatusData.lelantusGracefulPeriod || 0,
