    ...
    <div class="button-wrap">
        ...
        <multi-step-popover-buttons :steps="stepComponents"
            ...
            <template slot="step-passphrase" slot-scope="{ actions }">
                <send-step-passphrase-buttons :actions="actions"
                                              :color="submitButtonColor"
                                              :can-submit="canSubmit">
                </send-step-passphrase-buttons>
            </template>
        ...
        <send-confirm-dialog :can-submit="canSubmit"
                             ...
                             :queued-payments="pendingPaymentsSize"
...
<script>
    ...
    import SendStepPassphrase from '@/components/SendZcoinPage/SendStepPassphrase'
    import SendStepPassphraseButtons from '@/components/SendZcoinPage/SendStepPassphraseButtons'
